...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error(`[ClayCompetitorWebhook] Directory load error: ${err.message}`)
  }
  ...
  console.log(`[ClayCompetitorWebhook] Inserted: ${company_name} — ${job_title} (matched: ${matched_name || 'none'})`)
