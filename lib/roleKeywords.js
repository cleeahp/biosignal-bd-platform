...
export const EXCLUDED_ROLE_PATTERNS = /\b(intern|internship|co-op|coop|co op|student worker|graduate trainee|apprentice|sales rep|sales representative|account executive|account manager|business development rep|BDR|SDR|sales development|inside sales|outside sales|territory manager|sales manager|sales director|VP of sales|regional sales|national accounts|key accounts|sales engineer|presales|pre-sales|commercial director)\b/i
