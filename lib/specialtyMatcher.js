...
const SPECIALTY_RULES = [
  ...
  { name: 'Clinical Monitoring', keywords: ['clinical research', 'clinical trial', 'clinical project', 'research associate', 'clinical operations'] },
  ...
  { name: 'Real World Evidence', keywords: ['real world evidence', 'heor', 'health economics', 'outcomes research'], wholeWord: ['rwe'] },
]
